...
wget --no-check-certificate https://raw.githubusercontent.com/chirimantecman/arch-i3-basic/main/chiri-arch-i3-basic-install-chroot.sh;
...
chmod +x chiri-arch-i3-basic-install-chroot.sh;
